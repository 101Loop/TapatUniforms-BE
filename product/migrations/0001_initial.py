    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(blank=True, choices=[('HS', 'HALF SLEEVES'), ('FS', 'FULL SLEEVES'), ('HP', 'HALF PANTS'), ('FP', 'FULL PANTS')], max_length=3, null=True, verbose_name='Product Type')),
