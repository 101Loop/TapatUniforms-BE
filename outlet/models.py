...
class OutletProduct(CreateUpdateModel):
    ...
    color_code = models.CharField(
        verbose_name=_("Color Code"), max_length=254, default=_("#fff")
    )
...
class OutletSubProduct(CreateUpdateModel):
    ...
    size = models.CharField(
        verbose_name=_("Size"), max_length=4, choices=PRODUCT_CHOICES, default="24"
    )
    price = models.DecimalField(
        verbose_name=_("Price"), max_digits=10, decimal_places=3
    )
    warehouse_stock = models.IntegerField(verbose_name=_("Warehouse Stock"), default=0)
    display_stock = models.IntegerField(verbose_name=_("Display Stock"), default=0)
