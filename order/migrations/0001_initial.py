    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='Create Date/Time')),
                ('update_date', models.DateTimeField(auto_now=True, verbose_name='Date/Time Modified')),
                ('product_quantity', models.IntegerField(verbose_name='Number of Items')),
                ('discount_type', models.CharField(choices=[('P', 'PERCENTAGE'), ('A', 'AMOUNT'), ('O', 'OTHER')], default='A', max_length=3, verbose_name='Discount Type')),
